...
class CommonNeighbors:
    def __init__(self, graph: nx.Graph):
        """
        Initialize Common Neighbors recommender.
    ...
    def compute_score(self, u: int, v: int) -> int:
        """
...
def demo():
    """Demonstration of Common Neighbors algorithm."""
    # Create sample graph
    ...
    # Evaluate
    metrics = cn.evaluate(train_graph, test_edges, k=20)
    print(f"\nEvaluation Metrics:")
